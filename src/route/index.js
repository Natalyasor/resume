...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      ...
      certificates: [
        {
          name: 'Davud Davudovuch',
          id: '123456',
        },
        {
          name: 'Ivan Davudovuch',
          id: '156788',
        },
        {
          name: 'Andriy Davudovuch',
          id: '154367',
        },
      ],
    },
          ...
          projects: [
            {
              ...
              about:
                'Airbnb competitor.Hight-load application for searching apartmens',
              ...
              awards: [
                {
                  name: 'Background varification - is a feature that provides users to prove that they are real persons',
                },
                {
